...
return [
    ...
    */
    ...
    'disks' => [
        ...
        'classes' => [
            'driver' => 'local',
            'root' => storage_path('app/public/classes'),
            'url' => env('APP_URL').'/storage/classes',
            'visibility' => 'public',
        ],
        'competitions' => [
            'driver' => 'local',
            'root' => storage_path('app/public/competitions'),
            'url' => env('APP_URL').'/storage/competitions',
            'visibility' => 'public',
        ],
        'diplomatheses' => [
            'driver' => 'local',
            'root' => storage_path('app/public/diplomatheses'),
            'url' => env('APP_URL').'/storage/diplomatheses',
            'visibility' => 'public',
        ],
        ...
        'itklubs' => [
            'driver' => 'local',
            'root' => storage_path('app/public/itklubs'),
            'url' => env('APP_URL').'/storage/itklubs',
            'visibility' => 'public',
        ],
