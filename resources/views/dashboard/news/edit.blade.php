    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            ...
            <div class="card card-primary card-outline">
                ...
                <div class="card-body">
                    <form method="post" action="{{route('dashboard.news.update', $new->slug)}}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-row">
                            <div class="form-group col-md-12 required">
                                <label>Cím</label>
                                <input name="title" type="text" class="form-control" value="{{$errors->any() ? old('title') : $new->title}}">
                            </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12 required">
                                <label>Dátum</label>
                                <input name="date" type="datetime-local" class="form-control" value="{{$errors->any() ? old('date') : \Carbon\Carbon::parse($new->date)->format('Y-m-d\TH:i')}}">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-12 required">
                                <label>Tartalom</label>
                                <textarea class="form-control" name="content" rows="5">{{$errors->any() ? old('content') : $new->content}}</textarea>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-12 required">
