    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            ...
            <div class="card card-primary card-outline">
                ...
                <div class="card-body">
                    <form method="post" action="{{route('dashboard.subjects.update', $subject->id)}}" enctype="multipart/form-data">
                        @csrf

                        <div class="form-row">
                            <div class="form-group col-md-12 required">
                                <label>Tantárgy neve</label>
                                <input name="name" type="text" class="form-control" value="{{$errors->any() ? old('name') : $subject->name}}">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-12 required">
