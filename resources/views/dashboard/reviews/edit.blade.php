...
@section('title', 'Vélemény módosítása')
                    ...
                    <form method="post" action="{{route('dashboard.reviews.update', $review->id)}}" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6 required">
                                ...
                                <input name="reviewer" type="text" class="form-control" value="{{$errors->any() ? old('reviewer') : $review->reviewer}}">
                            </div>
                            <div class="form-group col-md-6 required">
                                <label>Dátum</label>
                                <input name="date" type="date" class="form-control" value="{{$errors->any() ? old('date') : $review->date}}">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-12 required">
                                <label>Vélemény</label>
                                <textarea class="form-control" name="opinion" rows="5">{{$errors->any() ? old('opinion') : $review->opinion}}</textarea>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-12 required">
